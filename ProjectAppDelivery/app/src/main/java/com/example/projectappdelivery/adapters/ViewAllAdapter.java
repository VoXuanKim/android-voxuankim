package com.example.projectappdelivery.adapters;
...
import com.example.projectappdelivery.activities.DetailedActivity;
...
public class ViewAllAdapter extends RecyclerView.Adapter<ViewAllAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewAllAdapter.ViewHolder holder, int position) {
        ...
        if (list.get(position).getName().equals("Milk")){
            holder.price.setText(list.get(position).getPrice() + "/litre");
        }
